    ...
    <nav id="nav-bar">
      ...
      <h1 id="heading">Dashboard</h1>
        ...
        <div id="main-bottom">
            ...
            <div class="sub-head">
            <h4 id="head-trends">Latest Trends <i class='bx bx-info-circle' ></i></h4>
            <button @click="ProductPage" class="btn-sm">View More</button>
            <router-view></router-view>
            </div>
            <!-- progress bars -->
            <div v-for="progress in progressors" :key="progress.id" :value="progress.id"  id="progress-perc-bar">
              <div id="picture-brand" width="40px" height="40px">
                <img src="../assets/Untitled.jpg" >
              </div>
               <span id="name-brand">{{progress.name}}</span>
                <div id="progress-perc-1"
               
                :style="{background: progress.backgroundcolor, width: progress.width}">
              ...
              <div class="sales" v-for="sale in sales" :key="sale.id"  :value="sale.id">
