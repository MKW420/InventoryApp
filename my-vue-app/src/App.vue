  ...
  <HeaderTrack/>
    <section class="container">
       ...
       <div class="header">
            ...
            <p>Get your stock on lock.   Inventory Management system for Retail businesses Worldwide!</p>
...
.sqaurebx li{
    top:50vh;
    left:45vh;
    animation: sqaure 10s linear infinite;
}

.sqaurebx li:nth-child(2){
    top:200vh;
    left: 10vh;
    animation-delay: 1s;
}
.sqaurebx li:nth-child(3){
    top:200vh;
    left: 85vh;
    animation-delay: 2s;
}
.sqaurebx li:nth-child(4){
    top:190vh;
    left: 70vh;
    animation-delay: 3s;
}
.sqaurebx li:nth-child(5){
    top:180vh;
    left: 10vh;
    animation-delay: 4s;
}
...
.circlebx li:nth-child(2){

    left:35vw;
    animation-delay: 1s;
}
.circlebx li:nth-child(3){

    left:55vw;
    animation-delay: 2s;
}
.circlebx li:nth-child(4){

    left:75vw;
    animation-delay: 3s;
}
.circlebx li:nth-child(5){
